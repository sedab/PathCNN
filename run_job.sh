...
#nparam="--cuda --calc_val_auc  --augment --dropout=0.1 --lr=0.0001  --imgSize=224 --model_type=vgg16 --root_dir=/beegfs/sb3923/DeepCancer/alldata/lung_ds/lung_ds2TilesSorted/ --num_class=3 --tile_dict_path=/beegfs/sb3923/DeepCancer/alldata/lung_ds/lung_ds2_FileMappingDict.p"
