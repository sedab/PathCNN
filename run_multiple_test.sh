...
#input params
exp_name="breast_subtypes_3layers_tr"
test_val="test"
im_size="299" 
model="3layers"
...
#breast subtypes
#nparam="--root_dir=/beegfs/sb3923/DeepCancer/alldata/BreastSubtypes_basal_vs_rest_no_normal/BreastTilesSorted/ --num_class=2 --tile_dict_path=/beegfs/sb3923/DeepCancer/alldata/BreastSubtypes_basal_vs_rest_no_normal/Breast_FileMappingDict.p --val=${test_val} --imgSize=${im_size} --model_type=${model}"

nparam="--root_dir=/beegfs/sb3923/DeepCancer/alldata/BreastSubtypes_no_normal/BreastTilesSorted/ --num_class=4 --tile_dict_path=/beegfs/sb3923/DeepCancer/alldata/BreastSubtypes_no_normal/Breast_FileMappingDict.p --val=${test_val} --imgSize=${im_size} --model_type=${model}"
